...
/**
 * Filtro para las rutas admin. Primero verifica que se haya iniciado sesion
 * y luego que el usuario que se autenticó sea administrador
 * @author josecarlos
 */
public class RutasAdminFiltro implements Filter {
