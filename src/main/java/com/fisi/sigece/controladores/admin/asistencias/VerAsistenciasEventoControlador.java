 ...
 * @author josecarlos
 */
public class VerAsistenciasEventoControlador extends HttpServlet {
        ...
        try {
            ...
            if(idEventoString == null || idEventoString.equals("")){
                ...
                if(evento == null){
                    ...
                    request.getRequestDispatcher("/vistas/admin/asistencias/asistencias.jsp").forward(request, response);
                }
            }
        } catch (NumberFormatException | IOException | ServletException ex) {
            Logger.getLogger(VerAsistenciasEventoControlador.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
